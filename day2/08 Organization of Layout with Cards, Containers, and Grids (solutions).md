# Bootstrap Layout and Content Components - SOLUTIONS
...
<div class="card">
    <div class="card-body">
        ...
        <p class="card-text">Interactive visualization tool for analyzing research data.</p>
    </div>
</div>
```
...
<div class="card">
    <div class="card-body">
        <h3 class="card-title">Machine Learning Project</h3>
        <p class="card-text">A research project investigating neural network applications in genomics.</p>
        <p class="card-text">This project uses deep learning techniques to analyze genetic sequences.</p>
    </div>
</div>
```
...
<div class="card">
    ...
    <div class="card-body">
        <h3 class="card-title">Machine Learning for Genomics</h3>
        <p class="card-text">A comprehensive study on neural network applications in genetic analysis.</p>
    </div>
    <div class="card-footer">
        Published: 2024
    </div>
...
```html
<div class="card">
    <img src="/images/project2.jpg" class="card-img-top" alt="Dashboard screenshot">
    <div class="card-body">
        <h3 class="card-title">Data Visualization Project</h3>
        <p class="card-text">Interactive visualization of research data.</p>
    </div>
...
<div class="card">
    <img src="/images/experiment.jpg" class="card-img-top" alt="Lab experiment">
    <div class="card-body">
        <h3 class="card-title">Genomics Research</h3>
        <p class="card-text">Analyzing genetic sequences using machine learning.</p>
    </div>
    <div class="card-footer">
        Learn More
    </div>
...
<div class="card-group">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">Description of third project.</p>
        </div>
    </div>
</div>
```
...
<div class="card-group">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title">Project One</h3>
            <p class="card-text">Description of first project. This is a longer description that includes more details about the methodology, results, and implications of the research. It demonstrates how cards in a group maintain equal heights.</p>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
...
<div class="card border-danger mb-3">
    <div class="card-body">
        <h3 class="card-title">Urgent Project</h3>
        <p class="card-text">This project requires immediate attention.</p>
    </div>
</div>
```
...
<div class="card shadow-lg mb-3">
    <div class="card-body">
        <h3 class="card-title">Featured Research</h3>
        <p class="card-text">This research stands out from others.</p>
    </div>
</div>
```
...
**Solution:**
The container automatically adjusts its width at different breakpoints while maintaining margins on both sides. No code change needed - this is observation only.
...
<div class="container-fluid bg-light">
    ...
    <p class="text-center">I am a researcher in computational biology.</p>
</div>
```
...
<div class="container">
    <h2>Projects</h2>
    <p>My research projects and publications.</p>
</div>
```
...
**Solution:**
```html
<div class="container-fluid bg-dark text-white py-5 my-4">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-9">
            <h3>Main Content</h3>
            <p>Primary content goes here with more space.</p>
        </div>
    </div>
</div>
```
...
<div class="row g-4">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="card-title">Project Four</h3>
                <p class="card-text">Description of the project.</p>
            </div>
        </div>
    </div>
